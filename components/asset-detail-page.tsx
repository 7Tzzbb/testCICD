...
export default function AssetDetailPage() {
    ...
    // 资产变动列表
    const getAssetAtatementRecord = async (customPage?: number, type?: number) => {
        const currentPage = customPage || page
        const res = await getOrdersTransactionPageRecord(currentPage, pageSize, type, assetId)
        if (res.code == 0) {
                ...
                <main className="flex-1 container px-4 py-4">
                    <div className="space-y-4">
                        ...
                        <Card
                            ...
                            <CardContent className="p-6">
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-6">
                                    ...
                                    <div>
                                        <p className="text-sm opacity-80">{t('valuation')}</p>
                        ...
                        <div className="mb-4 qb-16">
                            ...
                            <Tabs defaultValue="0" className="w-full mb-4"
                            ...
                            <div className="space-y-3">
                                <InfiniteScroll
                                    ...
                                    {assetStatementRecords.map((transaction) => (
                                        <Card key={transaction.id} className="vibrant-card hover-glow mb-2">
                                            <CardContent className="p-4">
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <h3 className="font-medium">{transaction.assetName}-{formatStatusText(transaction)}</h3>
                                                            <span
