...
export default function AssetBuyPage() {
    ...
    const handleConfirm = async () => {
        ...
        if (canSplit && (!minTradeAmount || parseFloat(minTradeAmount) < 100)) {
            toast({
                title: t('enterValidMinQuantity'),
                description: t('minQuantityAtLeast100'),
                variant: "destructive",
                duration: 1500
            })
            return
                            ...
                            <CardContent className="p-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        <div className="flex items-center space-x-2 p-4 border border-gray-200 rounded-md bg-gray-50 w-full justify-between">
                                            <div className="flex items-center">
                                                <Checkbox
                                                    id="payment-bank"
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div>
                                        ...
                                        <ul className="list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                            ...
                                            <li>{t('buyWillCharge')}{feeRate * 100}%{t('feeSuffix')}</li>
