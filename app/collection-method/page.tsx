...
import {CollectionMethodManager} from "@/components/collection-method-manager"
import {useLanguage} from "@/lib/i18n/language-context";
import {WalletWatcher} from "@/components/wallet-watcher";

export default function CollectionMethodPage() {
    const {t} = useLanguage()
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
            <header
                ...
                <div className="container flex items-center h-14 px-4">
                    ...
                    <h1 className="font-bold text-lg">{t('paymentMethods')}</h1>
                </div>
            </header>
